...
const CONFIGURATOR_SLOT_DEFINITIONS: Record<ConfiguratorSlotKey, ConfiguratorSlotDefinition> = {
  cpu: { key: "cpu", group: "core", categorySlugs: ["processors", "cpus", "central-processing-units"] },
  motherboard: { key: "motherboard", group: "core", categorySlugs: ["motherboards", "main-boards"] },
  ram: { key: "ram", group: "core", categorySlugs: ["memory", "ram", "ddr-memory", "ddr4-memory", "ddr5-memory"] },
  gpu: { key: "gpu", group: "core", categorySlugs: ["graphics-cards", "video-cards", "gpus"] },
  storage: {
    key: "storage",
    group: "core",
    categorySlugs: [
  ...
  psu: {
    key: "psu",
    group: "core",
    categorySlugs: ["power-supplies", "power-supply-units", "psu", "power-supply"],
  },
  cooling: {
    key: "cooling",
    group: "core",
    categorySlugs: ["cooling", "coolers", "cpu-coolers", "cpu-cooling", "water-cooling", "liquid-cooling", "fans"],
  },
  case: {
    key: "case",
    group: "core",
    categorySlugs: ["cases", "pc-cases", "computer-cases", "system-cases", "pc-towers", "корпуси"],
  },
  monitor: {
    key: "monitor",
    group: "extras",
    categorySlugs: ["monitors", "displays", "gaming-monitors", "монітори"],
  },
  keyboard: {
    key: "keyboard",
    group: "extras",
    categorySlugs: ["keyboards", "mechanical-keyboards", "gaming-keyboards", "клавіатури", "peripherals"],
    includeKeywords: ["keyboard", "klav", "клав", "g915"],
  },
  mouse: {
    key: "mouse",
    group: "extras",
    categorySlugs: ["mice", "computer-mice", "gaming-mice", "мишки", "миші", "peripherals"],
    includeKeywords: ["mouse", "superlight", "мыш", "миша"],
  },
  headset: {
    key: "headset",
    group: "extras",
    categorySlugs: ["headsets", "headphones", "gaming-headsets", "гарнітури", "навушники", "peripherals"],
    includeKeywords: ["headset", "headphone", "гарнит", "навуш"],
  },
  accessories: {
    key: "accessories",
    group: "extras",
    categorySlugs: ["accessories", "pc-accessories", "аксесуари", "peripherals"],
    excludeKeywords: [
      "keyboard",
      "klav",
      "клав",
