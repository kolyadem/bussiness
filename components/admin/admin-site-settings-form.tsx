    ...
    <form action={formAction} className="space-y-8">
      ...
      <section className="rounded-[2rem] border border-[color:var(--color-line-strong)] bg-[color:var(--color-surface)] p-6 shadow-[var(--shadow-soft)]">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <label className="grid gap-2 text-sm text-[color:var(--color-text-soft)]"><span>Email</span><input name="supportEmail" type="email" defaultValue={initialValues.supportEmail} className="h-11 rounded-[1rem] border border-[color:var(--color-line)] bg-[color:var(--color-surface-elevated)] px-4 text-[color:var(--color-text)] outline-none" /></label>
          <label className="grid gap-2 text-sm text-[color:var(--color-text-soft)]"><span>{locale === "uk" ? "Телефон" : locale === "ru" ? "Телефон" : "Phone"}</span><input name="supportPhone" defaultValue={initialValues.supportPhone} className="h-11 rounded-[1rem] border border-[color:var(--color-line)] bg-[color:var(--color-surface-elevated)] px-4 text-[color:var(--color-text)] outline-none" /></label>
          <label className="grid gap-2 text-sm text-[color:var(--color-text-soft)]"><span>{locale === "uk" ? "Адреса" : locale === "ru" ? "Адрес" : "Address"}</span><input name="address" defaultValue={initialValues.address} className="h-11 rounded-[1rem] border border-[color:var(--color-line)] bg-[color:var(--color-surface-elevated)] px-4 text-[color:var(--color-text)] outline-none" /></label>
        </div>
      </section>
